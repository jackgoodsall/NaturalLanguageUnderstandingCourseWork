...
RUN_DIR = ROOT / 'experiments/runs/C_REMOTE_A40_018_transfer_smoke'
OUTPUT_ROOT = ROOT / 'outputs/deberta_v3_transfer_3ep'
...
summary = {
    'run_id': 'C_REMOTE_A40_018',
    'variant': 'deberta_v3_transfer_3ep',
    'device': DEVICE,
    'config': CONFIG,
